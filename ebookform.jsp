...
<td><form:input path="author"></form:input></td>
	...
	<td>
	<form:radiobutton path="category.categor_id" value="1"/>New Arrivals
	<form:radiobutton path="category.category_id" value="2"/>Special Edition	
	<form:radiobutton path="category.category_id" value="3"/>Discount Sale
	<form:radiobutton path="category.category_id" value="4"/>General
	</td>
	</tr>
	<tr>
